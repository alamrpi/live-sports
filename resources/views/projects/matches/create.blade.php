    ...
    <div class="container-fluid px-4">
        ...
        <div class="card">
            <div class="card-header">
                <span class="card-subtitle">Match Create</span>
                <a href="{{ route('matches/index') }}" class="btn btn-sm btn-primary float-end"><i
                            class="fas fa-table"></i> Matches</a>
            </div>
            <div class="card-body">
                    ...
                    <div class="col-12">
                        <form action="{{ route('matches/store') }}" method="POST">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-7">
                                    <select class="form-select form-select-sm" name="league_id" disabled id="league_id" required>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-7">
                                    <div class="input-group input-group-sm">
                                        <select class="form-select form-select-sm" disabled name="club_id_one" id="club_id_one"
                                                required>
                                            <option value="">--Please select sport--</option>
                                        </select>
                                        <label for="club_id_two" class="input-group-text">VS</label>
                                        <select class="form-select form-select-sm" disabled name="club_id_two" id="club_id_two"
                                                required>
                                            <option value="">--Please select sport--</option>
                                        </select>
                                    </div>
                            ...
                            <div class="row mt-2">
                                <label for="sport_type" class="col-md-3 text-end">Sport Type <span
                                            class="text-danger">*</span></label>
                                <div class="col-md-7">
                                    <select class="form-select form-select-sm" name="sport_type" id="sport_type" onchange="changedMatchType(this.value)" required>
                                        <option value="">--Select--</option>
                            ...
                            <div class="row mt-2" id="channel_section" style="display: none;">
