jQuery(document).ready(function($) {
    ...
    if ($('.defaultCountdown').length) {
        const date = $('#count_down_date').val();
        const dates_digit = date.split('-');
        const austDay = new Date(dates_digit[2], (dates_digit[1] -1), dates_digit[0], dates_digit[3], dates_digit[4]);
